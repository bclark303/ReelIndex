...
The Windows and Docker/Unraid editions use the same v1.4.7 FastAPI backend and
browser interface.
...
[`dist/ReelIndex-Windows-Setup-v1.4.7.exe`](dist/ReelIndex-Windows-Setup-v1.4.7.exe).
...
```text
ghcr.io/bclark303/reelindex:1.4.7
```
