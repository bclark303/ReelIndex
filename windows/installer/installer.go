...
func main() {
	if msg("ReelIndex Setup", "Install ReelIndex Movie Inventory for this Windows user?\n\nSetup installs ReelIndex 1.4.1 and its Windows runtime. Internet access is required by this standard installer; an existing offline-builder package can capture a fully self-contained installer.", 0x44|0x20) != 6 {
		return
	}
